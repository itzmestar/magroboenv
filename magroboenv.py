...
class MagRoboEnv(gym.Env):
    ...
    def __init__(self):
        ...
        # observation is the x, y, z coordinate & magnetic moments of the grid
        ...
        if myconfig.Config.CURR_DEVIATE_ACTIVE:
            ...
            self.action_space = spaces.Box(low=MProbe.Current.deviate_action_low,
                                           high=MProbe.Current.deviate_action_high,
                                           dtype=np.int8)
